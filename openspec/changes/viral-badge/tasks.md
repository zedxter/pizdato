...
## T4а: Проверить отображение по умолчанию

- Файл: `frontend/src/SharePanel.tsx`
- Убедиться, что превью в SharePanel рендерит **горизонтальную версию** (720×280) — как сейчас
- Вертикальная версия только в кнопке «Сторис», на сайте не отображается
- Проверить оба состояния: после голоса «пиздато» и «хуёво»
- Оценка: 15 минут
