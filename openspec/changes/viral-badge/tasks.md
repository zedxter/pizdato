...
## T0а: Привести пилюли к референсу `badge-horizontal-v1.png`

- Файл: `frontend/src/badge.ts`
- Убедиться, что `drawPill()` рисует пилюли строго одинакового размера независимо от длины текста (фиксированная ширина для обеих, равная максимальной из двух)
- Проверить шрифты, цвета, градиенты, отступы — всё должно соответствовать `badge-horizontal-v1.png`
- Проверить оба варианта: «пиздато» и «хуёво»
- Оценка: 15 минут
