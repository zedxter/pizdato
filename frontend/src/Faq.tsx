...
const FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: (
      <>
        Страница <a href="/pizdato">«Пиздато»</a> — про смысл слова, голос
        человека, новости в общем счёте и почему один клик всё ещё имеет смысл.
        Короткие разборы — в <a href="/articles">статьях</a>. Технические детали
        (cookie, один голос, антиабус) — здесь, в FAQ.
      </>
    ),
  },
  {
